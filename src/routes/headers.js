...
import { getHeaderForEdit, logAuditEvent } from "../utils.js";
...
const assetConfig = {
  ...
  listView: "global/headers_list",
  newView: "global/new_header",
  editView: "global/edit_header",
  redirectPath: "/headers",
  getAssetFunction: getHeaderForEdit,
};
